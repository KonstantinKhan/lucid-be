...
| [`components/schemas/task-extantion.yaml`](../specs/components/schemas/task-extantion.yaml) | Defines schemas for extensions to the core task model, such as priority and time tracking.                  |
